...
const requiredConstraints = [
  ...
  'employees_deleted_by_platform_admin_fk',
  'employees_deleted_state_valid',
  ...
  'platform_admins_removal_state_valid',
  'platform_admins_removal_timestamps_valid',
  'platform_admin_first_enrollment_requests_session_admin_fk',
  'platform_admin_first_enrollment_requests_state_valid',
  'platform_admin_invitations_display_name_valid',
  'platform_admin_invitations_email_valid',
  'platform_admin_invitations_state_valid',
  'platform_admin_invitations_status_valid',
  'platform_admin_invitations_timestamps_valid',
...
const requiredIndexes = [
  ...
  'employees_operational_store_status_idx',
  ...
  'platform_admin_invitations_pending_email_idx',
  ...
  'platform_admins_removed_retention_idx',
...
const expectedSecurityDefinerFunctions = [
  ...
  'create_platform_employee',
  'delete_platform_employee',
